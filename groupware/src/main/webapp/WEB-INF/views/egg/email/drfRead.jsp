                ...
                <div class="card-body">
                    ...
                    <div class="page-aside-right">
                        ...
                        <div class="mt-3">
                            ...
                            <hr>
                            <div class="mt-5">
                                <a href="${pageContext.request.contextPath}/egg/mail/compose?replyTo=${mail.sendId}&subject=${mail.emlTtl}&content=${mail.emlCn}" class="btn btn-secondary me-2">
                                    <i class="mdi mdi-reply me-1"></i> 이어서 작성하기
                                </a>
                            </div>
                        </div>
                        <!-- end .mt-4 -->
