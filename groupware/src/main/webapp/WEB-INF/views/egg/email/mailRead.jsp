                           ...
                           <div>
							   ...
							   <ul>
							       <c:forEach var="file" items="${files}">
							           <li>
							               <a href="${pageContext.request.contextPath}/egg/mail/download?fileGroupNo=${file.fileGroupNo}&fileNo=${file.fileNo}" target="_blank">
							                   ${file.fileOrgnlNm}
							               </a>
							           </li>
							       </c:forEach>
                            ...
                            <div class="mt-5">
                                <a href="${pageContext.request.contextPath}/egg/mail/compose?replyTo=${mail.sendId}" class="btn btn-secondary me-2">
