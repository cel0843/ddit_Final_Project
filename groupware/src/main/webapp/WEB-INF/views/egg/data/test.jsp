	...
	<div class="row">
	  <div class="col-sm-10">
	    ...
	    <div class="d-inline-block">
			...
			<button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg">파일업로드</button>
...
//        				</div>
//        			</div>"
//        	 					   $(location).html("사용 불가능한 아이디입니다.").css("color" , "red");
//        	 					   idCheckFlag = false; //중복확인 비완료
//        	 				   }
//        	 			   }
//        	 		   })
//         })
