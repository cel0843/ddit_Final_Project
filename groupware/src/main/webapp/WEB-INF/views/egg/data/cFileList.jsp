...
<%-- 	                <c:choose> --%>
<%--                        <c:when test="${fn:length(data.fldNm) gt 7}"> --%>
<%--                            <c:out value="${fn:substring(file.fileOrgnlNm, 0, 6)} " />··· <br> --%>
<%--                        </c:when> --%>
<%--                        <c:otherwise> --%>
	                ...
	                <c:choose>
					    <c:when test="${data.fldNo eq fldNo}">
					        <div class="d-inline-block">
					            <a  style="color: blue;" class="ri-folder-5-fill" href="/egg/data/cFileList?fileGroupNo=${data.fileGroupNo}&fldNo=${data.fldNo}">
					                ${data.fldNm }
					            </a>
					        </div>
					    </c:when>
...
<script type="text/javascript">
    ...
    search.on("keyup", function() {
        ...
        $.ajax({
            url: "/egg/data/commonFolderSearch",
            type: "post",
