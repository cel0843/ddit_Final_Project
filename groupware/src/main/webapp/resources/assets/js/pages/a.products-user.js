$(document).ready(function() {
    ...
    $("#products-datatable").DataTable({
        language: {
            ...
            info: "Showing surveies _START_ to _END_ of _TOTAL_",
        ...
        columns: [{
            ...
            render: function(e, l, a, o) {
                return e = "display" === l ? '<div class="form-check"><input type="checkbox" class="form-check-input dt-checkboxes"><label class="form-check-label">&nbsp;</label></div>' : e
            },
            checkboxes: {
                selectRow: !0,
